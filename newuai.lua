function CriarJanelaBase(Titulo,Largura,Altura,TomPrimario)
...
function CriarJanelaFunc(WinB,Titulo)
...
function CriarTogg(JanB,Titulo,afunc)
...
function CriarButt(JanB,Titulo,afunc)
